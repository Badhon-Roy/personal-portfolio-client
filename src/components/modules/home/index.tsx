...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            <div className="z-10 xl:flex items-center justify-between w-full gap-8 lg:flex-row xl:mt-0 mt-32">
                ...
                <div className="flex-1 text-center md:text-left relative">
                    ...
                    <div className="flex items-center justify-center md:gap-4 gap-2 md:justify-start mt-6">
                        <button data-aos="zoom-in" className="my-4 BTN">
                ...
                {/* RIGHT IMAGE */}
                <div className="flex-1 gap-10 w-full md:mt-0 mt-8 overflow-x-auto xl:my-0 my-8">
                    <div className="min-w-[700px] relative bg-gradient-to-tr from-[#60a5f9] via-[#4cbace] to-[#34d29a] p-[2px] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                        <div className="bg-[#091121] backdrop-blur-xl text-[#D4D4D4] rounded-xl font-mono leading-relaxed relative transition-all duration-300">
                            ...
                            <div className="whitespace-pre-wrap tracking-wide space-y-1 p-6">
                                ...
                                <AnimatedSpan delay={500} className="flex md:items-center">
                                    &nbsp;&nbsp;<span className="text-[#efbe53]">name</span>: <span className="text-[#a5d6ff]">'Badhon Roy'</span>,
                                </AnimatedSpan>

                                <AnimatedSpan delay={1000} className="flex md:items-center">
                                ...
                                <AnimatedSpan delay={1500} className="flex md:items-center">
                                    &nbsp;&nbsp;<span className="text-[#efbe53]">skills</span>: [
                                </AnimatedSpan>

                                <AnimatedSpan delay={1800} className="flex md:items-center">
                                ...
                                <AnimatedSpan delay={2100} className="flex md:items-center">
                                ...
                                <AnimatedSpan delay={2400} className="flex md:items-center">
