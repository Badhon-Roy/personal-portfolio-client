...
const Navbar = () => {
  return (
    <div className="container mx-auto py-2 md:px-10 px-2 z-30 md:flex justify-between items-center sticky md:top-5 top-0 bg-opacity-10 bg-gray-100 backdrop-filter backdrop-blur-lg">
      <div>
